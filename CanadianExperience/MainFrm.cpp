...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_PLAY_CHANGEMACHINE, &CMainFrame::OnPlayChangemachine)
	ON_COMMAND(ID_PLAY_CHANGEMACHINE2, &CMainFrame::OnPlayChangemachine2)
END_MESSAGE_MAP()
...
void CMainFrame::OnPlayChangemachine()
{
	
	CMachineDlg dlg(mPicture->GetMachine1());
	if (dlg.DoModal() == IDOK)
	{
	}
	mPicture->UpdateObservers();
...
void CMainFrame::OnPlayChangemachine2()
{
	CMachineDlg dlg(mPicture->GetMachine2());
	if (dlg.DoModal() == IDOK)
	{
