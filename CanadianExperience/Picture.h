...
public:
	...
	*/
	void ChangeMachineNum();
	/** \brief Set Machine1
	 * \param machine set the machine1 */
	void SetMachine1(std::shared_ptr<CMachine> machine) { mMachine1 = machine; }
	/** \brief Set Machine2
	 * \param machine set the machine1 */
	void SetMachine2(std::shared_ptr<CMachine> machine) { mMachine2 = machine; }
	/** \brief Get a pointer to the machine1
   * \returns machine1*/
	std::shared_ptr<CMachine>GetMachine1() { return mMachine1; }
	/** \brief Get a pointer to the machine1
   * \returns machine2*/
...
private:
	...
	///first machine
	std::shared_ptr<CMachine> mMachine1;
	///second machine
	std::shared_ptr<CMachine> mMachine2;
};
